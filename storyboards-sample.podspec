...
Pod::Spec.new do |s|
  s.name             = "storyboards-sample"
  s.version          = "0.1.0"
  s.summary          = "A short description of storyboards-sample."
  s.description      = <<-DESC
                       An optional longer description of storyboards-sample
  ...
  s.resource_bundles = {
    'storyboards-sample' => ['Pod/Assets/*.png']
  }
